...
#define OLED_DC_PIN GET_PIN(B, 4)
#define OLED_CS_PIN GET_PIN(B, 3)
...
void OLED_Init(void)
{
    ...
    // rt_pin_write(OLED_SCL_PIN, 1);
    // rt_pin_write(OLED_SDA_PIN, 0);
    // rt_pin_write(OLED_RST_PIN, 1);
    // rt_pin_write(OLED_DC_PIN, 1);
    // rt_pin_write(OLED_CS_PIN, 0);
